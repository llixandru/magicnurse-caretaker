    ...
    function(ko, Context, moduleUtils, CoreRouter, ModuleRouterAdapter, KnockoutRouterAdapter, UrlParamAdapter, ArrayDataProvider, OffcanvasUtils, KnockoutTemplateUtils) {
        ...
        function ControllerViewModel() {
            ...
            */
            ...
            var navData = [
                { path: '', redirect: 'login' },
                { path: 'profile', detail: { label: 'Schedule', iconClass: 'oj-ux-ico-contact-group' } },
                { path: 'dashboard', detail: { label: 'Refill Prescription', iconClass: 'oj-ux-ico-bar-chart' } },
                { path: 'login', detail: { label: 'Logout', iconClass: 'oj-ux-ico-information-s' } }
            ];
            // Router setup
